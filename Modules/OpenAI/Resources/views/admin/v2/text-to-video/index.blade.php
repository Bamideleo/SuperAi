...
@section('page_title', __('Text To Video'))
...
<script type="text/javascript">
    'use strict';
    var listContaner = "text-to-video-list-container";
    var endRoute = "/text-to-video/";
</script>

<script src="{{ asset('public/dist/js/custom/video.min.js') }}"></script>
