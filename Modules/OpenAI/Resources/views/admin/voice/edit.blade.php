                                    ...
                                    <div class="form-group row preview-parent">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="custom-file position-relative media-manager-img" data-val="single"
                                                data-returntype="ids" id="image-status" data-type='{{ implode(',', getFileExtensions(3)) }}'>
                                        ...
                                        <div class="col-sm-10">
                                            <div class="d-flex align-items-start mt-2">
                                                ...
                                                <div class="d-flex flex-column col-sm-12">
                                                    <span
                                                        class="px-4">{{ __('Allowed File Extensions: jpg, jpeg, png and Maximum File Size :x MB', ['x' => preference('file_size')]) }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
