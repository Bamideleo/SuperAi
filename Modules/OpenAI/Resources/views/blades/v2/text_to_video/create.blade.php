...
@section('page_title', __('Text To Video Maker'))
@section('content')
    {{-- main content --}}
    <div 
        ...
        <div
            ...
            <div class="xl:w-[401px] 5xl:w-[474px] pt-14">
                @include('openai::blades.v2.text_to_video.form')
            </div>
            <div class="grow xl:px-0 px-5 xl:pt-[74px] pt-0 9xl:pb-[46px] pb-24 xl:w-1/2">
                <div class="xl:mt-4 ltr:xl:mr-12 rtl:xl:ml-12">
                    ...
                    <div id="text-to-video-gallery"></div>
                </div>
            </div>
        </div>
    </div>
...
@section('js')
    <script>
        'use strict';
        var PROMT_URL = "{{ !empty($promptUrl) ? $promptUrl : '' }}";
        $("#tooltip-2").tooltip();

    </script>
    <script src="{{ asset('public/dist/js/custom/validation.min.js') }}"></script>
    <script src="{{ asset('Modules/OpenAI/Resources/assets/js/customer/video/script.min.js') }}"></script>
@endsection
