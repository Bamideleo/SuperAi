...
class OpenAIController extends Controller
{
    ...
    public function createContentPreferences(AiPreferenceRequest $request, ChatBot $chatBot, PermissionsChecker $checker)
    {
        ...
        $permission = $request->only('hide_template', 'hide_image', 'hide_code', 'hide_speech_to_text', 'hide_text_to_speech', 'hide_long_article', 'hide_chat', 'hide_plagiarism', 'hide_aichatbot', 'hide_ai_detector', 'hide_voice_clone');
