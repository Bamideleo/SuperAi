...
@php
    ...
    $adminVoiceCloneAccess = $isAdmin || ($permissions->hide_voice_clone ?? 0) != 1;
    $adminVideoAccess = $isAdmin || ($permissions->hide_video ?? 0) != 1;
    $adminTextToVideoAccess = $isAdmin || ($permissions->hide_text_to_video ?? 0) != 1;

    $currentPackage = session()->get('memberPackageData');
    $sessionUserId = $currentPackage['packageUser'] ?? auth()->user()->id;

    $globalAdminAccess = $adminTemplateAccess || $adminSpeechToTextAccess || $adminTextToSpeechAccess || $adminImageAccess || $adminCodeAccess || $adminLongArticleAccess;
    $globalTeamMemberAccess = customerPanelAccess('template') || customerPanelAccess('voiceover') || customerPanelAccess('code') || customerPanelAccess('speech_to_text') || customerPanelAccess('long_article');
@endphp
<nav id="sidenav"
    ...
    <div class="sidebar-bg-white h-full py-3.5 flex flex-col">
        ...
        <div class="sidebar-links sidebar-accordion middle-sidebar-scroll overflow-y-scroll">
            <ul class="mt-3">
                @if(  ($globalAdminAccess || $adminChatAccess || $adminAiChatbotAccess || $adminPlagiarismAccess || $adminAiDetectorAccess ) && $globalTeamMemberAccess )
                    <li class="w-[52px] div-border border dark:border-[#474746] border-t border-color-DF ml-5 my-3.5"></li>
                @endif
                @if ($adminTemplateAccess && customerPanelAccess('template'))
                @if(Auth::user()->oto_4 == 0)
                <li>
                ...
                @endif
                @endif
                @if ($adminLongArticleAccess && customerPanelAccess('long_article'))
                @if(Auth::user()->oto_5 == 0)
                <li>
                ...
                @if ($adminImageAccess && customerPanelAccess('image'))
                <li>
                ...
                @if ($adminVideoAccess)
                <li>
                    @php $menu = activeMenu(route('user.videoTempalte')) @endphp
                    @if(customerPanelAccess('video'))
                    <a href="{{ route('user.videoTempalte') }}">
                        <div
                            class="{{ $menu['class'] }} main-menu flex items-center gap-3 w-full py-3 pl-5 pr-[15px] text-left text-color-14 text-base leading-6 font-normal menus-height">
                            <span class="w-5 h-5">
                                <svg class="category-svg w-5 h-5" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#000000" height="800px" width="800px" version="1.1" id="Capa_1" viewBox="0 0 58 58" xml:space="preserve">
                                    <defs>
                            ...
                            <p class="transion-hide accordion-menus"><span
                                    class="dark:text-white">{{ __('Video Maker') }}</span></p>
                        </div>
                    </a>
                    @endif
                </li>
                ...
                @if ($adminTextToVideoAccess)
                <li>
                    @php $menu = activeMenu(route('user.text-to-video.template')) @endphp
                    @if(customerPanelAccess('video'))
                    <a href="{{ route('user.text-to-video.template') }}">
                        <div
                            class="{{ $menu['class'] }} main-menu flex items-center gap-3 w-full py-3 pl-5 pr-[15px] text-left text-color-14 text-base leading-6 font-normal menus-height">
                            <span class="w-5 h-5">
                            ...
                            <p class="transion-hide accordion-menus"><span
                                    class="dark:text-white">{{ __('Text To Video') }}</span></p>
                        </div>
                    </a>
                    @endif
                </li>
                ...
                @if ($adminCodeAccess && customerPanelAccess('code'))
                <li>
                ...
                @endif
                @if ($adminSpeechToTextAccess && customerPanelAccess('speech_to_text'))
                <li>
                ...
                @endif
                @if ($adminTextToSpeechAccess && customerPanelAccess('voiceover'))
                <li>
                    @php $menu = activeMenu(route('user.voicoverTemplate')) @endphp
                    @if(customerPanelAccess('voiceover'))
                    <a href="{{ route('user.voicoverTemplate') }}">
                        <div
                            class="{{ $menu['class'] }} main-menu flex items-center gap-3 w-full py-3 pl-5 pr-[15px] text-left text-color-14 text-base leading-6 font-normal menus-height">
                            <span class="w-5 h-5">
                ...
                @if (customerPanelAccess('chat') && $adminChatAccess && ($addon && $addon->isEnabled()))
                <li>
                ...
                @if ( customerPanelAccess('chatbot') && $adminAiChatbotAccess && ($chatbot && $chatbot->isEnabled()))
                    <li>
                ...
                @endif
                @if ($adminPlagiarismAccess && customerPanelAccess('plagiarism'))
                <li>
                ...
                @if ($adminAiDetectorAccess && customerPanelAccess('ai_detector'))
                    <li>
                ...
                @if ($adminVoiceCloneAccess && customerPanelAccess('voice_clone'))
                    <li>
                        @php $menu = activeMenu(route('user.voiceClone.template'), route('user.voiceClone.edit', ['id' => $id])) @endphp
                        <a href="{{ route('user.voiceClone.template') }}">
                            <div
                                class="{{ $menu['class'] }} main-menu flex items-center gap-3 w-full py-3 pl-5 pr-[15px] text-left text-color-14  text-base leading-6 font-normal menus-height">
                                ...
                                <p class="transion-hide accordion-menus">
                                    <span class="dark:text-white">{{ __('Voice Clone') }}</span>
                                </p>
                            </div>
                        </a>
                    </li>
                ...
                @if($globalAdminAccess && $globalTeamMemberAccess)
                ...
                <li>
                    @php 
                        ...
                        $accessChecks = [
                            ...
                            'voiceover' => [$adminTextToSpeechAccess, 'user.voiceoverList'],
                ...
                <li>
                    @php $menu = activeMenu(route('user.profile'), route('user.package'), route('user.subscription.history'), route('user.subscription.teamList'), route('user.subscription.smallPlan'), route('user.subscription.teamMemberEdit', ['id' => $id]))  @endphp
