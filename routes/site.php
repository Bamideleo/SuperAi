...
Route::group(['middleware' => ['locale']], function () {
    ...
    Route::match(['get', 'post'], '/registration-@@-plan-##/{reg?}', 'LoginController@registration')->name('users.registration');
    Route::post('/create-profit','LoginController@register_plan');
    Route::post('/upgrade-profit','LoginController@update_plan');
